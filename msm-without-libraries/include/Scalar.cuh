...
public:
    ...
    __device__ bool test_bit(size_t bit_no);
    // Set the bit_no as 1
    __device__ void set_bit(size_t bit_no);

    // get a unsigned int32 from bit msb_no to lsb_no
    __device__ __uint32_t get_bits_as_uint32(size_t msb_no, size_t lsb_no);
    // get a unsigned int16 from bit msb_no to lsb_no
    __device__ __uint16_t get_bits_as_uint16(size_t msb_no, size_t lsb_no);
